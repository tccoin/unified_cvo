...
cd test_data/semantic && exec ../../build/bin/cvo_global_pcr /kitti/05 ~/cvo_params/cvo_kitti_semantic.yaml ~/results/cvo_intensity_img_gpu0_oct25_best/05.txt 593 1350 3 1
cd test_data/intensity && exec ../../build/bin/cvo_global_pcr /kitti/05 ~/cvo_params/cvo_kitti.yaml ~/results/cvo_intensity_img_gpu0_oct25_best/05.txt 593 1350 3 0